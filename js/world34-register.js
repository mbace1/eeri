...
// this shim mutates the SAME rooms.js?v=58 array that level.js re-exports.
...
import { ROOMS } from './rooms.js?v=58';
import { WORLD34_ROOMS } from './world34-rooms.js?v=58';
...
if (typeof window !== 'undefined') import('./world34-dressing.js?v=58');
