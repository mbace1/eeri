...
// this shim mutates the SAME rooms.js?v=37 array that level.js re-exports.
...
import { ROOMS } from './rooms.js?v=37';
import { WORLD34_ROOMS } from './world34-rooms.js?v=37';
...
if (typeof window !== 'undefined') import('./world34-dressing.js?v=37');
