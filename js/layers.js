...
import { PAL, LAYER_Z, LAYER_TINT, mix } from './palette.js?v=31';
import { getLayerTexture } from './assets.js?v=31';
import { buildPipeworksDressing } from './world2-dressing.js?v=31';
